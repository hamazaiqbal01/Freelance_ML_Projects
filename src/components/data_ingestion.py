...
class DataIngestionConfig: 
    train_test_split:str=os.path.join('artifacts' ,"train.csv")
...
class DataIngestion: 
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df=pd.read_csv('notebook\data\stud.csv') # Hewre you can import data from mongo db reaming code remain the same
